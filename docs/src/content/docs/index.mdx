...
hero:
  ...
  image:
    html: '<div class="hero-images"><img src="/grafana-react/img/hero-code.png" alt="JSX code for Stat panel" /><img src="/grafana-react/img/hero-grafana-stat-panel.png" alt="Rendered Grafana Stat panel" /></div>'
  actions:
    - text: Get Started
